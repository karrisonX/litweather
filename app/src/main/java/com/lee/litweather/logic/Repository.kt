...
import com.lee.litweather.logic.dao.PlaceDao
import com.lee.litweather.logic.model.Place
import com.lee.litweather.logic.model.Weather
    ...
    fun refreshWeather(lng: String, lat: String, placeName: String) = fire(Dispatchers.IO) {
        coroutineScope {
            val deferredRealtime = async {
                LitWeatherNetwork.getRealtimeWeather(lng, lat)
            }
            val deferredDaily = async {
                LitWeatherNetwork.getDailyWeather(lng, lat)
            }
